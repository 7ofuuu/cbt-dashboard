                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">{activity.grade_level}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Jurusan:</span>
                      <span className="font-medium">{activity.major}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Total Peserta:</span>
                      <span className="font-medium">{activity.participant_count}</span>
                    </div>
                  </div>
